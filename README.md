...
- [TypeScript](https://www.typscriptlang.org) 5.8
...
The `dist/` folder can be deployed to any static hosting (Vercel, Netlify, Cloudflare Pages, etc.). No server-side keys or environment variables needed.
